...
abstract class AbstractController extends AbstractActionController
{
    ...
    public function inserirAction()
    {
        ...
        if ($request->isPost()) {
            ...
            //var_dump($request->getPost());exit("teste");
            ...
            if ($request->isPost()) {
                ...
                if ($form->isValid()) {
                    ...
                    if ($service->save($data)) {
                        ...
                        $this->flashMessenger()->addErrorMessage('Não foi possível editar!');
                    }
    ...
    public function excluirAction()
    {
        ...
        if ($service->remove(array('id' => $id))){
            ...
            $this->flashMessenger()->addErrorMessage('Não foi possível excluir.');
        }
